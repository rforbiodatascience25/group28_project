...
::: column
![](images/combined_density_plot.png) ![](images/combined_histogram.png)
:::
:::::
...
-   Intercept: predicted mean of log fold change (control)

-   Slope: difference between T2D and control
...
::::: columns
::: column
![](images/Expression_median_plot-1.png)
:::

::: {.column width="60%" style="font-size: 60%;"}
![](images/Expression_median_boxplot-1-01.png)
...
![](images/06_over_under_expression_plot-1.png){fig-align="center"}
