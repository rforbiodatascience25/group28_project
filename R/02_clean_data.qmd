...
aggregated_data <- transformed_data |>
  ...
  slice_max(probe_median, n = 1, with_ties = FALSE) |>
  select(-probe_median) |>
  ungroup()
```
...
For some parts of the further analysis, a transposed format is more appropriate and this file is also created here. This data set has genes as columns and subjects as rows.
...
# Rename the col-names to genes found in the first row
