...
Counting the sample size for each group (diabetic and non-diabetic) based on the column "disease.state".
...
There are 54 in the control data set (non-diabetic).
...
The control data set (non-diabetic):
...
ggsave("../results/combined_density_plot.png", combined_density_plot)
```
...
ggsave("../results/combined_boxplot.png", combined_boxplot)
```
...
ggsave("../results/combined_histogram.png", combined_histogram)
```
